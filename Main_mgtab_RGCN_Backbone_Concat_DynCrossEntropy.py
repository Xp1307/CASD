...
if __name__ == '__main__':
    ...
    hetero_graph_list = torch.load('/data3/xupin/0_UNName/data/way_2/'+dataset_name+'_subgraphlist_augmented.pt',
                                   map_location='cuda:{}'.format(args.device_id))
    raw_graph_list = torch.load('/data3/xupin/0_UNName/data/way_2/'+dataset_name+'_subgraphlist.pt',
                                map_location='cuda:{}'.format(args.device_id))
