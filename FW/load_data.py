...
def load_mgtab_undirt(pt_raw_data_dir, args):
    ...
    if os.path.exists('/data/mgtab_undirct.pt'):
        data = torch.load('/data/mgtab_undirct.pt')
    ...
    torch.save(data, '/data/'+args.dataset+'_undirct.pt')
    return data
...
def load_mgtab(pt_raw_data_dir, args):
    ...
    '''
    path = pt_raw_data_dir
    if os.path.exists('/data/mgtab.pt'):
        data = torch.load('/data/mgtab.pt', map_location='cuda:'+str(args.device_id))
        print('Original Graph Already Exsists!')
        print(data)
        return data
    edge_index = torch.load(path + 'edge_index.pt')
    ...
    print(data)
    print('Original Graph Created Successfully!')
    torch.save(data, '/data/'+args.dataset+'.pt')
    return data
...
def load_pt_raw_data(pt_raw_data_dir):
    ...
    '''
    path = pt_raw_data_dir
    if os.path.exists('/data/twibot_20_pt_undirct.pt'):
        data = torch.load('/data/twibot_20_pt_undirct.pt')
        return data
    ...
    print(data)
    torch.save(data, '/data/twibot_20_pt_undirct.pt')
    return data
...
def load_pt_raw_data_twibot22(pt_raw_data_dir):
    ...
    '''
    path = pt_raw_data_dir
    if os.path.exists('/data/twibot_22_pt_undirct.pt'):
        data = torch.load('/data/twibot_22_pt_undirct.pt')
        print('original graph pt already exsist...')
        print(data)
        return data

    raw_data_dir = '/processed_data_twibot22/'
    ...
    print(data)
    torch.save(data, '/data/twibot_22_pt_undirct.pt')
    return data
...
def load_pt_raw_data_twibot22_100w():
    ...
    '''
    if os.path.exists('/data/twibot_22_100w_pt_undirct.pt'):
        data = torch.load('/data/twibot_22_100w_pt_undirct.pt')
        print('original graph pt already  xsist...')
        print(data)
        return data

    raw_data_dir = '/processed__raw_twibot_22/data/all_100w_nodes/processed/graph_component/'
    edge_index = torch.load(raw_data_dir + 'edge_index.pt')
    edge_type = torch.load(raw_data_dir + 'edge_type.pt')
    edge_index, edge_type = relational_undirected(edge_index, edge_type)
    ...
    print('original graph pt create successfully!')
    print(data)
    torch.save(data, '/data/twibot_22_100w_pt_undirct.pt')
    return data
...
def load_pt_raw_data_twibot22_100w_xlm():
    ...
    '''
    if os.path.exists('/data/twibot_22_100w_xlm_undirct.pt'):
        data = torch.load('/data/twibot_22_100w_xlm_undirct.pt')
        print('original graph pt already  xsist...')
        print(data)
        return data

    raw_data_dir = '/processed__raw_twibot_22/data/all_100w_nodes_xlm/processed/graph_component/'
    edge_index = torch.load(raw_data_dir + 'edge_index.pt')
    edge_type = torch.load(raw_data_dir + 'edge_type.pt')
    edge_index, edge_type = relational_undirected(edge_index, edge_type)
    ...
    print('original graph pt create successfully!')
    print(data)
    torch.save(data, '/data/twibot_22_100w_xlm_undirct.pt')
    return data
...
def hetero_to_homo(pt_data_dir):
    ...
    torch.save(Type_1_Original_Graph, '/data/twibot_22_type_1_pt_undirct.pt')
    print(Type_1_Original_Graph)
    print()
    ...
    torch.save(Type_2_Original_Graph, '/data/twibot_22_type_2_pt_undirct.pt')
    print(Type_2_Original_Graph)
    print()
    return [Type_1_Original_Graph, Type_2_Original_Graph]

#! 子异质图转化为多个同质图 (subgraph_hetero_to_homo)
def subgraph_hetero_to_homo(subgraph_list, dataset_name, type_num, save_dir='/data/way_2/'):
    '''
...
def subgraph_homo_to_hetero(pt_data_dir, edge_type_list, dataset_name='twibot_20'):
    '''
        ...
        @Param: edge_type_list | 边类型列表
    '''
    if (os.path.exists('/data/way_2/'+dataset_name+'_subgraphlist_hetero_to_type_1_node_hetero.pt')) and \
        (os.path.exists('/data/way_2/'+dataset_name+'_subgraphlist_hetero_to_type_2_node_hetero.pt')):
            print('already converted...')
            return
    type_1_homo_subgraph_list = torch.load('/data/way_2/'+dataset_name+'_subgraphlist_hetero_to_type_1_homo.pt')
    type_2_homo_subgraph_list = torch.load('/data/way_2/'+dataset_name+'_subgraphlist_hetero_to_type_2_homo.pt')
    ...
    torch.save(type_1_homo_subgraph_list, '/data/way_2/'+dataset_name+'_subgraphlist_hetero_to_type_1_node_hetero.pt')
    torch.save(type_2_homo_subgraph_list, '/data/way_2/'+dataset_name+'_subgraphlist_hetero_to_type_2_node_hetero.pt')
