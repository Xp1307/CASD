...
from FW.load_data import load_pt_raw_data_twibot22_100w
from FW.load_data import subgraph_hetero_to_homo
from FW.Graph_Split import Cluster_Split_Shuffle
...
if __name__ == '__main__':
    ...
    for edge_type_index in range(2):
        ...
        #! 保存增强后的结果
        torch.save(AugmentedGraph_List, '/data/way_2/'+ args.dataset_name+
