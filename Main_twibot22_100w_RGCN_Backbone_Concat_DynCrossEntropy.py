...
if __name__ == '__main__':
    ...
    hetero_graph_list = torch.load('/data3/data/way_2/twibot22_100w/'+dataset_name+'_subgraphlist_hetero_to_type_1_node_hetero.pt',
                                   map_location=device)
    raw_graph_list = torch.load('/data3/data/way_2/twibot22_100w/'+dataset_name+'_subgraphlist.pt',
                                map_location=device)
